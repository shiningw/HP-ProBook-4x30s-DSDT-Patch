 ...
 * 
 * Disassembly of DSDT.aml, Sun Mar 19 14:21:22 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000252A1 (152225)
 *     Revision         0x02
 *     Checksum         0x8B
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "198F    "
...
DefinitionBlock ("DSDT.aml", "DSDT", 2, "HPQOEM", "198F    ", 0x00000001)
{
    ...
    External (_SB_.PCI0.IGPU.DGCE, MethodObj)    // Warning: Unresolved method, guessing 0 arguments
...
HWAK (Arg0)
    ...
    Scope (\_SB)
    {
        Method (_INI, 0, NotSerialized)  // _INI: Initialize
        {
            ...
            // always store 0x07DC for "Darwin"
            Store (0x07DC, OSYS)
            //\_TZ.BOTT ()
            //\_TZ.RETD ()
            Store (One, PFLV)
    ...
    OperationRegion (GNVS, SystemMemory, 0xBBF68918, 0x019B)
    ...
    OperationRegion (ASMA, SystemMemory, 0xBBF6A018, 0x1060)
    Field (ASMA, AnyAcc, NoLock, Preserve)
    {
        ASMB,   33536
    }

    OperationRegion (AF10, SystemMemory, 0xBBF6C018, 0x10DE)
    ...
    OperationRegion (HPDF, SystemMemory, 0xBBF6EE18, 0x0183)
    ...
    OperationRegion (HPD2, SystemMemory, 0xBBE33F18, 0x006F)
    ...
    OperationRegion (HPBR, SystemMemory, 0xBBF69F18, 0x007E)
                ...
                Method (_PS0, 0, Serialized)  // _PS0: Power State 0
                {
                    ...
                    If (LEqual (PCHS, 0x02))
                    {
                        ...
                        If (LEqual (And (Local0, 0x000203FB), 0x02A0))
                        {
                            ...
                            While (LEqual (And (R510, 0x00180000), 0x00))
                            {
                                Stall (0x32)
                            }

                            And (R510, Not (0x02), Local0)
                        ...
                        If (LEqual (And (Local0, 0x000203FB), 0x02A0))
                        {
                            ...
                            While (LEqual (And (R520, 0x00180000), 0x00))
                            {
                                Stall (0x32)
                            }

                            And (R520, Not (0x02), Local0)
                        ...
                        If (LEqual (And (Local0, 0x000203FB), 0x02A0))
                        {
                            ...
                            While (LEqual (And (R530, 0x00180000), 0x00))
                            {
                                Stall (0x32)
                            }

                            And (R530, Not (0x02), Local0)
                        ...
                        If (LEqual (And (Local0, 0x000203FB), 0x02A0))
                        {
                            ...
                            While (LEqual (And (R540, 0x00180000), 0x00))
                            {
                                Stall (0x32)
                            }

                            And (R540, Not (0x02), Local0)
